      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <a class="brand" href="index.php">Directorio Minsal</a>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
            ...
            <p><a href="http://twitter.github.io/bootstrap/examples/fluid.html#" class="btn btn-primary btn-large">Learn more »</a></p>
          </div>
          <div class="row-fluid">
            <div class="span4">
              <h2>Heading</h2>
