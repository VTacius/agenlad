...
/**
 * Estoy en pleno desarrollo de la aplicación: 3
 * Estoy ya en producción: 0
 */
$index->set('DEBUG',0);
 ...
 */
$index->route('GET|POST /directorio', 'directorioControl->display');
$index->route('GET|POST @login: /login','loginControl->display');
$index->route('GET|POST @login_mensaje: /login/@mensaje','loginControl->display');
$index->route('GET|POST @login_inicio: /login/inicio', 'loginControl->autenticar');
$index->route('GET|POST @login_final: /login/final', 'loginControl->cerrar');
$index->route('GET|POST @main: /index', 'indexControl->display');
$index->route('GET|POST @main: /', 'indexControl->display');
$index->run();
